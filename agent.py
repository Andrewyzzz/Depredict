...
PREDICTION: <0-100 的数字>%"""
        ...
        result = self._parse_round1_response(response.choices[0].message.content)
    ...
    def debate(self, question: str, context_text: str, other_results: list[dict]) -> dict:
        ...
        return self._parse_round2_response(response.choices[0].message.content)
    ...
    def final_predict(self, question: str, context_text: str, all_debate_results: list[dict]) -> dict:
        ...
        return self._parse_round3_response(response.choices[0].message.content)
