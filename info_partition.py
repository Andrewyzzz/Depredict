...
import random
from config import INFO_PARTITION_SHARED_RATIO, INFO_PARTITION_PRIVATE_COUNT


def partition_documents(
    all_docs: list[dict],
    agent_names: list[str],
    shared_ratio: float = INFO_PARTITION_SHARED_RATIO,
    private_per_agent: int = INFO_PARTITION_PRIVATE_COUNT,
) -> dict[str, list[dict]]:
    """
